...
<div class="ui container first">
    <div class="ui center aligned teal inverted segment">
        <font color="black"><h1 class="header" id="nam"> 
Care connect: Streamlined Hospital appointment system</h1></font>
    </div>
  <div class="clear"> </div>
			<!--start-image-slider---->
